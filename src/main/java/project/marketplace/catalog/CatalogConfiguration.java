package project.marketplace.catalog;
...
@EnableJpaRepositories(
        basePackages = "project.marketplace.catalog",
...
public class CatalogConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean catalogEntityManagerFactory(@Qualifier("catalog") DataSource dataSource,
        ...
        return builder
                ...
                .packages("project.marketplace.catalog")
    ...
    @Primary
    @Bean
    public RedisConnectionFactory catalogRegisConnectionFactory(@Value("${catalog.redis.host}") String hostName,
